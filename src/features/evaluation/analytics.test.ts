...
test("pre-adoption unclaimed prescriptions are not treated as missed", () => {
  assert.equal(
    prescriptionComplianceState(prescription("historical", "2026-09-16"), "2026-09-23", null, "2026-09-23"),
    "NOT_CLAIMED",
  );
  assert.equal(
    prescriptionComplianceState(prescription("tracked", "2026-09-22"), "2026-09-23", null, "2026-09-21"),
    "MISSED",
  );
});
