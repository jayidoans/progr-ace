...
export default async function EditActivityPage({
  ...
  return (
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      {feedback.error ? <p className="rounded-md bg-red-50 px-4 py-3 text-sm text-red-700" role="alert">{feedback.error === "invalid-activity" ? "Check the activity values and try again." : "We couldn&apos;t update this activity. Please check the details and try again."}</p> : null}
