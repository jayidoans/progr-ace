...
const messages: Record<string,string> = {
  ...
  "cancellation-requested":"Cancellation request sent.",
  "cancellation-approved":"Cancellation approved.",
  "cancellation-declined":"Cancellation request declined.",
  "program-cancelled":"Training program cancelled.",
};
...
const errors: Record<string, string> = {
  ...
  "cancellation-request-failed":"The cancellation request could not be sent. It may already be waiting for review.",
  "cancellation-review-failed":"This cancellation request could not be reviewed. It may already have been reviewed.",
  "program-cancel-failed":"This program is no longer available for cancellation.",
};
